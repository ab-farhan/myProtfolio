    ...
    <div class="row">
        <div class="col-lg-8 offset-lg-2">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('dashboard.skill_section.store',) }}" method="post">
                        @csrf
                        ...
                        <div class="btn-group">
                            ...
                            <button data-selected="graduation-cap " type="button"
                                ...
                                </i> <i class=" fa fa-fw fa-heart iconpicker-component"></i>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                                name="heading" value="{{ old('heading') }}" placeholder="Enter heading...">
                        </div>
