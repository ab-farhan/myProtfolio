                            ...
                            <div class="card-body">
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item">{{__('About Me')}}
                                        <a data-text="{{__('About Me')}}" data-type="#about" class="addToMenus btn btn-primary btn-sm float-right" href="">{{__('Add to Menus')}}</a>
                                    </li>
                                    <li class="list-group-item">{{__('Service')}}
                                        <a data-text="{{__('Service')}}" data-type="#service" class="addToMenus btn btn-primary btn-sm float-right" href="">{{__('Add to Menus')}}</a>
                                    </li>
                                    <li class="list-group-item">{{__('Protfolio')}}
                                        <a data-text="{{__('Protfolio')}}" data-type="#protfolio" class="addToMenus btn btn-primary btn-sm float-right" href="">{{__('Add to Menus')}}</a>
                                    </li>
